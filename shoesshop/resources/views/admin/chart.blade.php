...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="icon" href="public/backend/favicon.ico" type="image/x-icon" />

        <link href="https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700,800" rel="stylesheet">
        
        <link rel="stylesheet" href="public/backend/plugins/bootstrap/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="public/backend/plugins/fontawesome-free/css/all.min.css">
        <link rel="stylesheet" href="public/backend/plugins/ionicons/dist/css/ionicons.min.css">
        <link rel="stylesheet" href="public/backend/plugins/icon-kit/dist/css/iconkit.min.css">
        <link rel="stylesheet" href="public/backend/plugins/perfect-scrollbar/css/perfect-scrollbar.css">
        <link rel="stylesheet" href="public/backend/plugins/weather-icons/css/weather-icons.min.css">
        <link rel="stylesheet" href="public/backend/plugins/owl.carousel/dist/assets/owl.carousel.min.css">
        <link rel="stylesheet" href="public/backend/plugins/owl.carousel/dist/assets/owl.theme.default.min.css">
        <link rel="stylesheet" href="public/backend/plugins/chartist/dist/chartist.min.css">
        <link rel="stylesheet" href="public/backend/dist/css/theme.min.css">
        <script src="public/backend/src/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                                    ...
                                    <div class="notifications-wrap">
                                        ...
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                                <img src="public/backend/img/users/1.jpg" class="rounded-circle" alt="">
                                            </span>
                                            <span class="media-body">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="public/backend/img/user.jpg" alt=""></a>
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <div class="logo-img">
                               <img src="public/backend/src/img/brand-white.svg" class="header-brand-img" alt="lavalite"> 
                            </div>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="public/backend/index.html"><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>
                                </div>
                                <div class="nav-item">
                                    ...
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="public/backend/index.html"><i class="ik ik-home"></i></a>
                                            </li>
                                            <li class="breadcrumb-item">
                                                <a href="#">Widgets</a>
                                            </li>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card sale-card" style="min-height: 301px;">
                                    ...
                                    <div class="card-block text-center">
                                        ...
                                        <p class="mb-10 text-left">Giày thể thao nam <span class="float-right">90%</span></p>
                                        <div class="progress mb-20">
                                            <div class="progress-bar bg-c-blue" style="width:90% ;height:50px;"></div>
                                        </div>
                                        <p class="mb-10 text-left">Giày thể thao nữ <span class="float-right">50%</span></p>
                                        <div class="progress mb-20">
                                            <div class="progress-bar bg-c-blue" style="width:50%"></div>
                                        </div>
                                        <p class="mb-10 text-left">Giày thể thao trẻ em <span class="float-right">30%</span></p>
                                        <div class="progress mb-20">
        ...
        <script>window.jQuery || document.write('<script src="public/backend/src/js/vendor/jquery-3.3.1.min.js"><\/script>')</script>
        <script src="public/backend/plugins/popper.js/dist/umd/popper.min.js"></script>
        <script src="public/backend/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="public/backend/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
        <script src="public/backend/plugins/screenfull/dist/screenfull.js"></script>
        <script src="public/backend/plugins/owl.carousel/dist/owl.carousel.min.js"></script>
        <script src="public/backend/plugins/chartist/dist/chartist.min.js"></script>
        <script src="public/backend/plugins/flot-charts/jquery.flot.js"></script>
        <script src="public/backend/plugins/flot-charts/jquery.flot.categories.js"></script>
        <script src="public/backend/plugins/flot-charts/curvedLines.js"></script>
        <script src="public/backend/plugins/flot-charts/jquery.flot.tooltip.min.js"></script>
        <script src="public/backend/plugins/jquery-knob/dist/jquery.knob.min.js"></script>
        <script src="public/backend/plugins/amcharts3/amcharts/amcharts.js"></script>
        <script src="public/backend/plugins/amcharts3/amcharts/gauge.js"></script>
        <script src="public/backend/plugins/amcharts3/amcharts/serial.js"></script>
        <script src="public/backend/plugins/amcharts3/amcharts/themes/light.js"></script>
        <script src="public/backend/plugins/amcharts3/amcharts/pie.js"></script>
        <script src="public/backend/plugins/ammap3/ammap/ammap.js"></script>
        <script src="public/backend/plugins/ammap3/ammap/maps/js/usaLow.js"></script>

        <script src="public/backend/dist/js/theme.min.js"></script>
        <script src="public/backend/js/widget-chart.js"></script>
